...
urlpatterns = [
    ...
    path('doc_list/', login_required(views.DoctorList.as_view()), name='doctor-list'),
    path('doc_detail/<int:pk>/', login_required(views.DoctorDetail.as_view()), name='doctor-detail'),
